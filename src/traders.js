...
(function(){
    ...
    [
			...
			new TradeItem({item_name: "Stale bread", count: [40,1000]}),
            new TradeItem({item_name: "Fresh bread", count: [20,500]}),
			new TradeItem({item_name: "Roasted rat meat", count: [20,500]}),
			new TradeItem({item_name: "Roasted purified rat meat", count: [20,500]}),
			new TradeItem({item_name: "Iron ingot", count: [20,500]}),
			new TradeItem({item_name: "1000 Years Pill", count: [20,50]}),
			new TradeItem({item_name: "TRUE ULTIMATE POWER", count: [1]}),
			new TradeItem({item_name: "Dragon Heart", count: [7]}),
    ...
    inventory_templates["General"] = 
    [
            new TradeItem({item_name: "Discount bread", count: [5,5]}),
			new TradeItem({item_name: "Discount healing powder", count: [5,5]}),
			...
			new TradeItem({item_name: "Joy of Woodcutting", count: [1], chance: 0.5}),
			new TradeItem({item_name: "Power of Dreams", count: [1], chance: 0.5}),
			new TradeItem({item_name: "Peak Literature", count: [1], chance: 0.1}),
			new TradeItem({item_name: "Twist liek a snek", count: [1], chance: 0.7}),
            new TradeItem({item_name: "Glass phial", count: [5,10], chance: 1}),
    ];
 inventory_templates["Smith"] = 
    [
            new TradeItem({item_name: "Cheap iron spear", count: [1], quality: [40, 90], chance: 0.8}),
            new TradeItem({item_name: "Cheap iron dagger", count: [1], quality: [40, 90], chance: 0.8}),
            new TradeItem({item_name: "Cheap iron sword", count: [1], quality: [40, 90], chance: 0.8}),
